...
VALUES ('Template', 12, 'imbal_port_fact_pv', 'imbal_port_fact_pv', 'if row[''IMBAL_PORT_GRP_PV''] == 1 and row[''ARRIVEDEPART''] == 1:
...
INSERT INTO ips.PROCESS_VARIABLE_PY (RUN_ID, PROCESS_VARIABLE_ID, PV_NAME, PV_DESC, PV_DEF)
VALUES ('Template', 56, 'SAMP_PORT_GRP_PV', 'SAMP_PORT_GRP_PV', 'if row[''PORTROUTE''] in (111,113,119,161,171):
...
INSERT INTO ips.PROCESS_VARIABLE_PY (RUN_ID, PROCESS_VARIABLE_ID, PV_NAME, PV_DESC, PV_DEF)
VALUES ('Template', 57, 'unsamp_port_grp_pv', 'unsamp_port_grp_pv', 'if row[''PORTROUTE''] in (111, 113, 119, 161):
...
INSERT INTO ips.PROCESS_VARIABLE_PY (RUN_ID, PROCESS_VARIABLE_ID, PV_NAME, PV_DESC, PV_DEF)
VALUES ('Template', 58, 'unsamp_region_grp_pv', 'unsamp_region_grp_pv', 'dvpc = 0
