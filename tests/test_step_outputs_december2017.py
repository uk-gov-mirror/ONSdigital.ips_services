...
def test_final_weight():
    ...
    survey_output(
        "FINAL",
        "data/calculations/december_2017/final_weight/surveydata_dec2017.csv",
        [
            'SERIAL', 'FINAL_WT'
        ]
    )
...
def test_rail_imputation():
    ...
    survey_output(
        "RAIL",
        "data/calculations/december_2017/rail/surveydata_rail_dec2017.csv",
        [
...
def test_regional_weight():
    ...
    survey_output(
        "REGIONAL",
        'data/calculations/december_2017/regional_weights/surveydata_regional_dec2017.csv',
        [
...
def test_town_stay_expenditure_imputation():
    ...
    survey_output(
        "TOWN_AND_STAY",
        "data/calculations/december_2017/town_and_stay/surveydata_town_dec2017.csv",
        [
